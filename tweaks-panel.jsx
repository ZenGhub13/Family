...
2. Upload these files to the root:
   - `Lucas Daily Sheet.html` (rename to `index.html` if you want it served at the root URL)
   - `styles.css`
   - `app.jsx`
   - `tweaks-panel.jsx`
...
- Wait ~30 seconds, then open the Pages URL.
- If the file isn't renamed to `index.html`, navigate to `…/Lucas%20Daily%20Sheet.html`.
